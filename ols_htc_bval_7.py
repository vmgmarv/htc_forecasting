# -*- coding: utf-8 -*-
"""
Created on Thu Jul  6 13:19:20 2023
...
df_lag = df_lag[['inflation','USGG_7Y']]
...
#
#df_in = df_train[['BVAL_7Y','USGG_7Y']]
#
df_in['Forecast'] = 2.52894365 + 0.11328281 * df_in.inflation_l2 + 0.88111417 * df_in.USGG_7Y_l1
df_in['BVAL_7Y'] = y
##
...
variables_.append('BVAL_7Y')
df_test = df_test[variables_]
#df_test = df_test[['BVAL_7Y','USGG_7Y']]
#
##vars_out = ['BVAL_7Y',  'm2',
##            'USGG_7Y',
##            'FED_FFR_l1'] 
...
df_out['Forecast'] = 2.52894365 + 0.11328281 * df_out.inflation_l2 + 0.88111417 * df_out.USGG_7Y_l1
